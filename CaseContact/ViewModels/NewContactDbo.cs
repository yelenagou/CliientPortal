...
namespace CaseContact.ViewModels
{
    public class NewContactDbo
    {
        ...
        public ContactDbo WorkInformation { get; set; } = new ContactDbo();
        ...
        //Active Attorney Information
        [Display(Name ="Are you represented by an Attorney at this time?")]
        public bool ExistingAttorney { get; set; }
    ...
    public class AttorneyDbo : ContactDbo
    {
        ...
        public string AttorneyLicenseNumber { get; set; } 
            public string AttorneyStaff1 { get; set; }
            [MaxLength(40)]
            public string AttorneyStaff1FirstName { get; set; }
            [MaxLength(40)]
            public string AttorneyStaff1LastName { get; set; }
            [DataType(DataType.PhoneNumber)]
            [RegularExpression(@"^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$", ErrorMessage = "Not a valid Phone number")]
            public string AttorneyStaff1TelephoneNumber { get; set; }
            [DataType(DataType.EmailAddress)]
            public string AttorneyStaff1EmailAddress { get; set; }
            [Display(Name = "Date Of Birth")]
            [DataType(DataType.Date)]
            public DateTime? AttorneyStaff1DateOfBirth { get; set; }
    }
